...
2. gh issue view 1 --repo tlo300/zelda-totk-guide
3. git checkout -b 1-short-description
4. gh issue edit 1 --add-label in-progress --repo tlo300/zelda-totk-guide

### Finishing an issue
1. All acceptance criteria checkboxes met
2. Relevant tests pass
3. git push origin {branch}
4. gh pr create --title "{issue title}" --body "Closes #1" --repo tlo300/zelda-totk-guide
5. gh issue edit 1 --remove-label in-progress --repo tlo300/zelda-totk-guide
6. Update Current state section below
7. git add CLAUDE.md && git commit -m "docs: update project state after #1"
...
|-------|-------|-----------|--------|
| #1    | Python pipeline scaffold and dev environment | 1 | backlog |
