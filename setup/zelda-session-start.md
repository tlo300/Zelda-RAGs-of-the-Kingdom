...
3. Run: gh issue list --repo {owner}/zelda-totk-guide --label in-progress --json number,title
   List anything currently in progress.

4. Run: gh issue list --repo {owner}/zelda-totk-guide --milestone "1 - Data pipeline and knowledge base" --state open --json number,title,labels
