...
## Repo
- GitHub: https://github.com/{owner}/zelda-totk-guide
...
2. gh issue view {number} --repo {owner}/zelda-totk-guide
3. git checkout -b {number}-short-description
4. gh issue edit {number} --add-label in-progress --repo {owner}/zelda-totk-guide

### Finishing an issue
1. All acceptance criteria checkboxes met
2. Relevant tests pass
3. git push origin {branch}
4. gh pr create --title "{issue title}" --body "Closes #{number}" --repo {owner}/zelda-totk-guide
5. gh issue edit {number} --remove-label in-progress --repo {owner}/zelda-totk-guide
